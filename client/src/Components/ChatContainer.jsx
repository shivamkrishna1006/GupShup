...
const ChatContainer = ({selectedUser,setSelectedUser}) => {
  ...
  return selectedUser ?(
   ...
   <img src={assets.profile_martin} alt="" className='w-8 rounded-full' />
    <p className='flex-1 text-lg text-white flex items-center gap-2'>laura
        <span className='w-2 h-2 rounded-full bg-[#147c6d]'></span>
    </p>
                ...
                {msg.image? (
                  <img src={msg.image} alt="" className='max-w-[230px] border border-gray-700 rounded-lg overflow-hidden mb-8'/>
                    ...
                    <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all
                       bg-[#00BCA1]/60 text-white ${msg.senderId=== '680f50e4f10f3cd28382ecf9' ? 
    ...
    bg-[#56d6c3]/10 max-md:hidden'>
        <img src={assets.logo_icon} alt="" className='max-w-16' />
        <p className='text-lg font-medium text-[#56d6c3]'>Let's do the GupShupp ?</p>
    </div>
